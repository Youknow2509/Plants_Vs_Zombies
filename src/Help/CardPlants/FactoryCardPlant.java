...
public class FactoryCardPlant {
    public static CardPlant createCardPlant(String name) {
        ...
        switch (name) {
            case "SUNFLOWER":
                return new CardPlant(Path.ASSETS_Image_Card_SunFlower, name, SunFlower.COST);
            case "PEASHOOTER":
                return new CardPlant(Path.ASSETS_Image_Card_PeaShooter, name, PeaShooter.COST);
            case "WALLNUT":
                return new CardPlant(Path.ASSETS_Image_Card_WallNut, name, Wallnut.COST);
            case "REPEATER":
                return new CardPlant(Path.ASSETS_Image_Card_Repeater, name, Repeater.COST);
            default:
                return null;
        }
    }

...
public class ActRepeater implements Act {
    ...
    public void attack(Object object) {
        Pea pea1 = new Pea((int) plant.getX() + 40, (int) plant.getY() + 25, plant.getLane(), ((Repeater)plant).getListPea());
        Pea pea2 = new Pea((int) plant.getX() + 52, (int) plant.getY() + 25, plant.getLane(), ((Repeater)plant).getListPea());
